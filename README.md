...
<head>
    ...
    <style>
        .hero-bg {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('background4.jpg'); /* Usa la imagen del campo de tréboles */
...
<body class="bg-slate-50 text-slate-800 font-sans">
    ...
    <nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 font-medium">
                ...
                <a href="#empresa" class="hover:text-emerald-600 transition">Empresa</a>
    ...
    <!-- Hero Section -->
    <header class="hero-bg h-[80vh] flex items-center text-white text-center px-6">
        <div class="container mx-auto max-w-4xl">
            <h1 class="text-4xl md:text-6xl font-extrabold mb-6">Impulsamos tu Éxito con Tecnología de Vanguardia</h1>
            ...
            <div class="flex flex-col md:flex-row justify-center gap-4">
                <a href="#servicios" class="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-full font-semibold transition text-lg">Nuestros Servicios</a>
    ...
    <section id="servicios" class="py-20 bg-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="mt-16 bg-slate-900 text-white rounded-3xl p-10 flex flex-col md:flex-row items-center justify-between">
                <div class="text-left md:w-2/3">
                    <h3 class="text-2xl font-bold mb-4">Soluciones Verticales</h3>
                    <p class="text-slate-400">Contamos con sistemas especializados para la gestión de **Restaurantes** y administración de **Citas Médicas**.</p>
                </div>
                <div class="mt-6 md:mt-0">
                    <a href="https://wa.me/593979267019" class="bg-emerald-600 hover:bg-emerald-700 px-6 py-3 rounded-xl font-bold transition">Solicitar Demo</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-slate-50 py-12 border-t border-slate-200">
        <div class="container mx-auto px-6 text-center">
            <div class="flex justify-center items-center space-x-2 mb-6">
                ...
                <span class="text-xl font-bold text-slate-800">Digital Clover</span>
            </div>
            <p class="text-slate-500 text-sm">© 2026 Digital Clover. Innovación que prospera.</p>
        </div>
    </footer>
